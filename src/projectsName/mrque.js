...
const sections = document.querySelectorAll(".page-contentt__section");
...
gsap.utils.toArray(".page-contentt__section h2").forEach((heading) => {
...
<main class="page-contentt">
  ...
  <section class="page-contentt__section" data-bg-color="#17202A">
  ...
  <section class="page-contentt__section" data-bg-color="#1C2833">
  ...
  <section class="page-contentt__section" data-bg-color="#212F3D">
  ...
  <section class="page-contentt__section" data-bg-color="#273746">
  ...
  <section class="page-contentt__section" data-bg-color="#2C3E50">
  ...
  <section class="page-contentt__section" data-bg-color="#34495E">
